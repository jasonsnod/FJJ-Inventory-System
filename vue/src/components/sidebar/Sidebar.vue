<template>
    ...
    <div class="sidebar" :style="{ width: sidebarWidth}">
        ...
        <Sidebarlink to="/inventory" icon="fa-solid fa-boxes-stacked">Inventory</Sidebarlink>
        <Sidebarlink to="/purchasing" icon="fa-solid fa-store">Purchasing</Sidebarlink>
        <Sidebarlink to="/picking" icon="fa-brands fa-wolf-pack-battalion">Picking</Sidebarlink>
